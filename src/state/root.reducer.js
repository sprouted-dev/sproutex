...
import balancesReducer,{SLICE_KEY as BALANCE_KEY} from '../balance/balances.slice';
import exchangeReducer, {SLICE_KEY as EXCHANGE_KEY, selectExchangeLoaded} from './exchange.slice';
...
import filledOrderReducer, {FILLED_ORDER_SLICE_KEY} from "../trades/filled-orders.slice";
...
export const rootReducer = combineReducers({
  ...
  [EXCHANGE_KEY]: exchangeReducer,
  [BALANCE_KEY]: balancesReducer,
